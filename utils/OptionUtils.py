...
#input options for all the of the different scripts. Not all options are used for everything
    ...
    parser.add_argument("--sig2_file", type = str, default = "",  help="Load second signal from separate file")
    ...
    parser.add_argument("--lund_weights", default = True, action = "store_true",  help="Use Lund Weights for signal file")
    ...
    parser.add_argument("--sig2_per_batch", type = float, default = -1.,  help="Reduce signal2 to this number of events  in each batch (< 0 to not use )")
